...
export default function GoogleButton({mode='login'}: GoogleButtonProps) {
    ...
    return (
        ...
        className="flex items-center justify-center gap-3 w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-100"
        >
        <svg
        ...
        >
            ...
            <path
            fill="#4CAF50"
            d="M24 44c5.2 0 10-2 13.5-5.3l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.8-3.3-11.4-8l-6.5 5C9.5 39.5 16.2 44 24 44z"
            />
            <path
            fill="#1976D2"
